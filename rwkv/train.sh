...
#######################################################################################################################
#
M_BSZ="64" # CAN be 16 but for parity w fla it's 8
LR_INIT="1e-4"
LR_FINAL="1e-5"
#
...
DATA_PATH=/home/wavefunction/mirex2025/sym-music-gen/data/filtered_aria/train
#
...
uv run train.py --train_data $DATA_PATH \
